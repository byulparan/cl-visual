...
(defmethod gfx:draw ((view shader-surface))
  (let* ((w (gfx:width view))
    ...
    (gfx:with-shader (view (shader view) (gpu-stream (renderer *visual-canvas*)) program)
      ...
      (gl:uniform-matrix-4fv (gl:get-uniform-location program "projection_matrix") (gfx:projection-matrix view))
      (gl:uniform-matrix-4fv (gl:get-uniform-location program "modelview_matrix") (gfx:modelview-matrix view))
      (apply #'gl:uniformf (gl:get-uniform-location program "imouse") (imouse (renderer *visual-canvas*)))
